...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-o2n-m48.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-o2n-m48.containers.anotherwebservice.com/
...
```
git clone git@github.com:rotelecom/container-o2n-m48.git
cd container-o2n-m48
```
...
```
docker attach container-o2n-m48
```
